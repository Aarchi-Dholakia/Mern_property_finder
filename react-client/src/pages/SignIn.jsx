...
export default function SignIn() {
  ...
  return (
    <div className='p-6 max-w-md mx-auto bg-white rounded-xl shadow-md overflow-hidden md:max-w-2xl mt-10'>
      <div className='p-8'>
        <h1 className='text-3xl text-center font-bold text-indigo-900 mb-8'>Welcome Back</h1>
        ...
        <form onSubmit={handleSubmit} className='flex flex-col gap-6'>
          ...
          <button
            disabled={loading}
            className='w-full bg-teal-600 text-white p-3 rounded-lg uppercase font-medium hover:bg-teal-700 disabled:opacity-70 transition-colors duration-300 shadow-md'
          >
            {loading ? (
        ...
        <div className='mt-6 text-center text-indigo-700'>
          <p>Don't have an account?{' '}
            <Link to={'/sign-up'} className='font-medium text-teal-600 hover:text-teal-700 hover:underline'>
              Sign up
            </Link>
          </p>
        </div>
