                    ...
                    <div className='flex flex-wrap gap-6'>
                        <div className='flex items-center gap-2'>
                            <input
                                ...
                                max='10'
                                required
                                className='p-3 border border-indigo-200 rounded-lg focus:ring-2 focus:ring-teal-300 focus:border-transparent'
                                onChange={handleChange}
                ...
                <div className='flex flex-col flex-1 gap-4'>
                    ...
                    {formData.imageUrls.length > 0 &&
                        formData.imageUrls.map((url, index) => (
                            <div
                                key={url}
                                className='flex justify-between p-3 border border-indigo-200 rounded-lg items-center bg-cyan-50'
                            >
                                <img
                                    src={url}
                                    alt='listing image'
                                ...
                                <button
                                    ...
                                    className='p-3 text-red-600 hover:text-red-800 rounded-lg uppercase hover:bg-red-200 transition-colors'
                                >
                                    Delete
                                </button>
                            </div>
